    ...
    `}>
      <div className='pb-5'>
        <div className='flex justify-between items-center'>
          ...
          <div className='relative py-2 group'>
            ...
            border border-gray-600 text-gray-100 hidden group-hover:block'>
              <Link to={'/profile'} className='text-sm'>Edit Profile</Link>
        ...
        <div className='bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5'>
          ...
          <input onChange={(ev) => {setInput(ev.target.value)}} value={input} type="text" className='bg-transparent border-none outline-none text-white
